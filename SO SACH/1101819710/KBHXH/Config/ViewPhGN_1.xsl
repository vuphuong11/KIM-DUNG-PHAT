									...
									<tbody>
										...
										<tr>
											...
											<td style="font-size:10pt; white-space:nowrap" colspan="2" align="center" valign="middle">
												<i>
													<xsl:value-of select="BaoHiemDienTu/ThongTinDonVi/DiaDiem"/>,
												</i>
												<i>
													<xsl:variable name="dt" select="BaoHiemDienTu/ThongTinDonVi/NgayLap"></xsl:variable>
										...
										<tr style="font-size:10pt">
											...
											<td align="left" valign="middle">
												...
												Email: <xsl:value-of select="BaoHiemDienTu/ThongTinDonVi/Email"/>
