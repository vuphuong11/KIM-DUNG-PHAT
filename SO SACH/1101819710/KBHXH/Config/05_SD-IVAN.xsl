										...
										<tr>
											<td colspan="3" align="center" valign="middle">
												...
												<span style="font-size:11pt">
													<b>Thay đổi, bổ sung thông tin đăng ký sử dụng dịch vụ I-VAN</b>
												</span>
												<br />
                        <br />
												<span style="font-size:11pt">
								...
								<table>
									...
									<tbody>
										...
										<tr>
											<td align="left" valign="middle">
												<span style="padding-left:20px">&#160;</span>
												Căn cứ Tờ khai đăng ký sử dụng dịch vụ I-VAN ngày <xsl:value-of select="BHXH/DKI_BHXH/TTDVI/NGAY_DKI"/>, chúng tôi đề nghị thay đổi, bổ sung thông tin đã đăng ký, cụ thể như sau:
											</td>
										</tr>
                          ...
                          - Tên tổ chức chứng thực chữ ký số: <xsl:value-of select="BHXH/DKI_BHXH/TTCKY_DVI/TTCKY/SUBJECT"/>
										...
										<tr>
											<td align="left" valign="middle">
												<span style="padding-left:20px">&#160;</span>
												- Thời hạn sử dụng chứng thư số: Từ ngày <xsl:value-of select="BHXH/DKI_BHXH/TTCKY_DVI/TTCKY/BEGIN"/> đến ngày <xsl:value-of select="BHXH/DKI_BHXH/TTCKY_DVI/TTCKY/END"/>
											</td>
										</tr>
										<tr>
											<td align="left" valign="middle">
										...
										<tr>
											<td align="left" valign="middle">
												<span style="padding-left:20px">&#160;</span>
												<i>(Chỉ nghi những nội dung có thay đổi, bổ sung)</i>
											</td>
										</tr>
										<tr>
											<td align="left" valign="middle">
												<div style="padding-left:28px">Chúng tôi cam kết hoàn toàn trách nhiệm trước pháp luật về tính chính xác, trung thực của nội dung nêu trên./.</div>
											</td>
										</tr>
